      ...
      return (
        <div>
          <div className="payment-container">
            ...
            <a href={"https://www.coinbase.com/oauth/authorize/oauth_signin?client_id=4b953dc5193c8d5842635395fda00c14fe227309b0962b9072f826382864599b&redirect_uri=https%3A%2F%2Finwest.io%2Fcallback&response_type=code&scope=wallet:deposits:create,wallet:transactions:send,wallet:accounts:read,wallet:payment-methods:read,wallet:orders:read,wallet:buys:create&account=all&referral=5926fed0af2b9403ec411b7f&meta[send_limit_amount]=1&meta[send_limit_currency]=USD&meta[send_limit_period]=day&state="+ user.id } target="_blank"><button className="btn btn-bank">Connect Coinbase</button></a>
